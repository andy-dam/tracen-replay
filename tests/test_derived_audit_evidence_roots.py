...
from scripts.audit_derived_source_causes import _bind_external_evidence_root, main
        ...
        with workspace_temp() as directory:
            ...
            for errors in ([], [{'kind': 'missing_source_evidence'}]):
                ...
                with patch('sys.argv', argv), \
                     patch('scripts.audit_derived_source_causes.audit', return_value=result), \
                     patch('scripts.audit_derived_source_causes._render_markdown', return_value='audit'), \
