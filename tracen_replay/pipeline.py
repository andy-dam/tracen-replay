...
def analyze(source, output, start=0, duration=57, fps=4, annotations=None, track_stats=False, tesseract=None):
    ...
    if track_stats and (video['width'], video['height']) != (1920, 1080):
