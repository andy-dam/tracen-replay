  ...
  <div class="guide">
    ...
    <section class="guide-section">
      ...
      <ul class="guide-list">
        ...
        <li><b>Not Read.</b> Story text, supporter introductions, the side panel, and anything without a number or a named effect. Recordings other than the English game at 1080p in landscape are not supported.</li>
      </ul>
    </section>
