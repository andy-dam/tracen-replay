...
<template>
  <div class="card signin">
    ...
    <form @submit.prevent="submit">
      ...
      <p v-if="mode === 'create' && hosted" class="muted small" style="margin-top: 14px">By creating an account, you agree to the <a href="#/terms">Terms of Use</a> and the <a href="#/privacy">Privacy Policy</a>.</p>
      <p class="muted small" style="margin-top: 14px">
        {{ mode === "create" ? (hosted ? "Passwords need at least 8 characters." : "Passwords need at least 8 characters. Accounts exist only on this computer.") : "New here? Create an account to upload a recording." }}
      </p>
    </form>
  </div>
</template>
