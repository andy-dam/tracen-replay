...
Run from the repository root with::
    ...
    python scripts/inventory_derived_reliability.py
...
def _render_markdown(result: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "",
        f"Generated by `scripts/inventory_derived_reliability.py` from the three reports in `{input_directory}` and their inventories.",
