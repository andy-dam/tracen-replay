        ...
        "synthetic_test_files": [
            {
                ...
                "sha256": sha256(ROOT / "tests/test_training_gain_resolution.py"),
            },
            {
                "path": "tests/test_training_gain_phases.py",
                "sha256": sha256(ROOT / "tests/test_training_gain_phases.py"),
            },
            {
                "path": "tests/test_training_gain_recovery.py",
                "sha256": sha256(ROOT / "tests/test_training_gain_recovery.py"),
            },
        ],
    },
