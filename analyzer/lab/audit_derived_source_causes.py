...
def _render_markdown(result: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "",
        f"Generated by analyzer/lab/audit_derived_source_causes.py from reports in `{input_directory}` and the canonical G5 inventory.",
        "",
    ...
    lines.extend(
        [
            ...
            "",
            "Run `python analyzer/lab/audit_derived_source_causes.py` from the repository root. The script reads only the selected report directory, the canonical derived audit, and the frozen source-case selection. It does not edit recognizers or rerun recognition.",
            "",
