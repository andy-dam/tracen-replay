...
from tools import evaluate_final_numeric_cases as numeric_evaluator
from lab.regrade_source_phase_numeric import (
    AUDIT_DIR,
    NUMERIC_CAUSES,
    SOURCE_PHASE,
    bound_file,
...
def main() -> None:
    ...
    full_recording_path = ROOT / "analyzer" / "tracen_replay" / "full_recording.py"
    evaluator_path = ROOT / "analyzer" / "tools" / "evaluate_final_numeric_cases.py"
    ...
    document: dict[str, Any] = {
        ...
        "integrity": {
            ...
            "transactions_sha256": digest(ROOT / "analyzer" / "tracen_replay" / "transactions.py"),
            "turn_ledger_sha256": digest(ROOT / "analyzer" / "tracen_replay" / "turn_ledger.py"),
            "causal_accounting_sha256": digest(ROOT / "analyzer" / "tracen_replay" / "causal_accounting.py"),
            "event_choice_adapter_sha256": digest(ROOT / "analyzer" / "tracen_replay" / "event_choice_adapter.py"),
        },
        "aggregate": {
