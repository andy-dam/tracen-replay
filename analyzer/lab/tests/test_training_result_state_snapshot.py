"""Tests of ``tests.test_training_result_state_snapshot`` that need locally preserved evidence; they run only where it is."""
import copy
import json
import unittest
...
from tests.test_training_result_state_snapshot import SOURCE_RAW
