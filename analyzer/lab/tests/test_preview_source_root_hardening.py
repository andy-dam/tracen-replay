"""Tests of ``tests.test_preview_source_root_hardening`` that need locally preserved evidence; they run only where it is."""
...
from tests.test_preview_source_root_hardening import REPORT, SOURCE_ROOT
