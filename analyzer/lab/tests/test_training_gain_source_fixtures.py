"""Tests of ``tests.test_training_gain_source_fixtures`` that need locally preserved evidence; they run only where it is."""
...
from tests.test_training_gain_source_fixtures import BUILDER, FIXTURE, ROOT
