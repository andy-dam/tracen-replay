"""Tests of ``tests.test_lesson_offer_adapter`` that need locally preserved evidence; they run only where it is."""
...
from tests.test_lesson_offer_adapter import BASE, GAMEPLAY_094, GAMEPLAY_121, RAW_094, RAW_121, SOURCE_094, SOURCE_121, SOURCE_SHA256, _load, _offer, _values
