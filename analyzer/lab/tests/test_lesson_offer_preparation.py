"""Tests of ``tests.test_lesson_offer_preparation`` that need locally preserved evidence; they run only where it is."""
...
from tests.test_lesson_offer_preparation import GAMEPLAY_PATH, RAW_PATH, SOURCE_FRAME_PATH, _SourceCropReader
