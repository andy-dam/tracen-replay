"""Tests of ``tests.test_final_source_adjudication`` that need locally preserved evidence; they run only where it is."""
import copy
import hashlib
import json
import unittest
...
from tests.test_final_source_adjudication import ACTION_INTERVAL_ARTIFACT, BASELINE, MODIFIER_ARTIFACT, PREVIEW_ARTIFACT, RACE_ARTIFACT, RECORDING, REFERENCE
