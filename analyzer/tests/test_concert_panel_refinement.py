...
class ConcertPanelRefinementTests(unittest.TestCase):
    def setUp(self):
        self.raw = json.loads(Path("analyzer/tests/fixtures/concert-panels.json").read_text(encoding="utf-8"))[0]["raw"]
        self.fixture = json.loads(Path("analyzer/tests/fixtures/concert-panel-refinement-v1.json").read_text(encoding="utf-8"))
