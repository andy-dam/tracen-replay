...
from tools.freeze_final_reliability import RUNS, digest, freeze, validate_references, verify_manifest
...
class ReferenceFreezeTests(unittest.TestCase):
    def setUp(self):
        ...
        code = self.root / 'analyzer' / 'tracen_replay'
    ...
    def test_freeze_accepts_code_changes_but_rejects_mutated_reference(self):
        self.create()
        (self.root/'analyzer'/'tracen_replay'/'reader.py').write_text('# tuned implementation',encoding='utf-8')
        self.verify()
