...
The separate recording has 119 balanced stat intervals and five unresolved, 111 balanced performance intervals and two unresolved, and all 11 fan intervals balanced. Its current evidence audit verifies 11,331 observations and 10,094 refinements with zero provenance errors. Two subsequently extended fan-alignment records also passed their raw/proof hash checks. These improvements are regression results. The original recording retains its balanced ledgers and both complete cart-charge assignments.
